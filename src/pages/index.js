...
and web apps, using components, react.js, and atomic CSS.
		...
		<Box
			...
			sm-right="0px"
			sm-box-shadow="none"
			sm-border-width="1px 0px 0px 0px "
			sm-border-style="solid"
			sm-border-color="--color-greyL1"
			sm-border-radius="0px"
			sm-justify-content="center"
			xs-padding="4px 8px 4px 8px"
		>
			<Image
				width="128px"
				height="128px"
				src="https://uploads.quarkly.io/atomize-site/atomize_product_hunt.png"
				margin="0px 24px 0px -24px"
				sm-width="68px"
				sm-height="68px"
				sm-margin="0px 24px 0px 0px"
				xs-margin="0px 4px 0px 0px"
				xs-width="48px"
				xs-height="48px"
			/>
			<Box
			...
			>
				<Text
					font="normal 600 20px/1.2 --fontFamily-googleSourceSansPro"
					letter-spacing=".5px"
					text-align="left"
					margin="16px 0px 6px 0px"
					sm-margin="6px 17px 6px 0px"
					xs-font="normal 600 12px/1.2 --fontFamily-googleSourceSansPro"
					xs-margin="6px 8px 6px 0px"
			...
			Product Hunt!
				...
				<Link
					...
					sm-width="auto"
					xs-font="normal 400 12px/1.5 --fontFamily-googleSourceSansPro"
					xs-padding="6px 8px 6px 8px"
					text-align="center"
					text-decoration-line="initial"
					color="#ffffff"
					target="_blank"
					href="https://www.producthunt.com/posts/atomize-by-quarkly"
				>
					Review us
				</Link>
			</Box>
